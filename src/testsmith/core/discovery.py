...
def discover_untested_files(project_root: Path, test_root: Path, config: TestSmithConfig) -> list[Path]:
    """
...
def discover_files_in_path(target_path: Path, project_root: Path, test_root: Path, config: TestSmithConfig) -> list[Path]:
    """
