...
When workspaces are configured in .assay.yaml, all workspaces are validated.

Examples:
  assay validate
  assay validate --path src/services/
  assay validate --lang java
  assay validate --format json
  assay validate --format junit
