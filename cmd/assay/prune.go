...
When workspaces are configured in .assay.yaml, all workspaces are pruned.

Examples:
  assay prune           # list unused fixtures (dry-run)
  assay prune --confirm # actually delete them
  assay prune --workspace api`,
