...
Examples:
  ...
  testsmith migrate --from junit4 --to junit5
  testsmith migrate --from pytest-mock --to unittest.mock
  testsmith migrate --from nunit --to xunit --dry-run
  testsmith migrate --from jest --to vitest --path src/components/`,
